...
// Next.js API routes default to a 1mb body size limit. Base64-encoded audio
// files (and even decent photos) blow past that easily, causing the request
// to fail with 413 before this handler ever runs — which looks exactly like
// "upload does nothing" on the client. Bump it up for this route only.
export const config = {
  api: {
    bodyParser: {
      sizeLimit: '15mb',
